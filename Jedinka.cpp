...
namespace GA {
    ...
    double Jedinka::getVjerojatnostP() const {
        return vjerojatnostP;
    }

    void Jedinka::setVjerojatnostP(double vjerojatnostP) {
        Jedinka::vjerojatnostP = vjerojatnostP;
    }
    ...
    void Jedinka::setX(const std::vector<int> &x) {
        Jedinka::x = x;
    }
